...
class Trip(models.Model):
    ...
    # Geolocation fields
    departure_lat = models.DecimalField(max_digits=9, decimal_places=6, null=True, blank=True)
    departure_lng = models.DecimalField(max_digits=9, decimal_places=6, null=True, blank=True)
...
class RecurringTrip(models.Model):
    ...
    # Missing fields to match Trip
    transport_type = models.CharField(max_length=20, choices=Trip.TRANSPORT_TYPE_CHOICES, default='car')
    description = models.TextField(blank=True)
    luggage_size = models.CharField(max_length=50, default='Moyen')
    accepts_pets = models.BooleanField(default=False)
    accepts_smoking = models.BooleanField(default=False)
